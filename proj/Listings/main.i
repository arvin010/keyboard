...
const KeyIOMap rMap[] = {
	...
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)),     ((uint16_t)0x0001), ((uint8_t)0x00), ((uint8_t)0x00)},  		
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)),     ((uint16_t)0x0002), ((uint8_t)0x00), ((uint8_t)0x01)},  		
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)),     ((uint16_t)0x0004), ((uint8_t)0x00), ((uint8_t)0x02)},  		
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)),     ((uint16_t)0x0008), ((uint8_t)0x00), ((uint8_t)0x03)},  		
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)),     ((uint16_t)0x0010), ((uint8_t)0x00), ((uint8_t)0x04)},  		
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)),     ((uint16_t)0x0020), ((uint8_t)0x00), ((uint8_t)0x05)},  		
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)),     ((uint16_t)0x0040), ((uint8_t)0x00), ((uint8_t)0x06)},  		
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)),     ((uint16_t)0x0080), ((uint8_t)0x00), ((uint8_t)0x07)},  		
};
...
const KeyIOMap cMap[] = {
	...
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),     ((uint16_t)0x0001) , ((uint8_t)0x01), ((uint8_t)0x00) },   	
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),     ((uint16_t)0x0002) , ((uint8_t)0x01), ((uint8_t)0x01) },   	
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),     ((uint16_t)0x0004) , ((uint8_t)0x01), ((uint8_t)0x02) },  		
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),     ((uint16_t)0x0400), ((uint8_t)0x01), ((uint8_t)0x0A)},  		
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),     ((uint16_t)0x0800), ((uint8_t)0x01), ((uint8_t)0x0B)},   	
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),     ((uint16_t)0x1000), ((uint8_t)0x01), ((uint8_t)0x0C)},  		
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),     ((uint16_t)0x2000), ((uint8_t)0x01), ((uint8_t)0x0D)},  		
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),     ((uint16_t)0x4000), ((uint8_t)0x01), ((uint8_t)0x0E)},  		
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),     ((uint16_t)0x8000), ((uint8_t)0x01), ((uint8_t)0x0F)},  		
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)),     ((uint16_t)0x8000), ((uint8_t)0x00), ((uint8_t)0x0F)},  		
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),     ((uint16_t)0x0008) , ((uint8_t)0x01), ((uint8_t)0x03) },   	
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),     ((uint16_t)0x0010) , ((uint8_t)0x01), ((uint8_t)0x04) },   	
...
{  
    ...
    0x11, 0x10, 0x0B, 0x0D, 0x18, 0x1C, 0x23, 0x24, 
    0x00, 0x00, 0x00, 0xE5, 0x00, 0xE1, 0x00, 0x00, 
    0x00, 0x1B, 0x00, 0x16, 0x1A, 0x39, 0x3A, 0x1F, 
...
void send_keycode(matrix_t* matrix)
{
	...
	if(flag < 8)
	{
		...
		USB_EP_Tx(0x01, key_send_buff, sizeof(key_send_buff));
