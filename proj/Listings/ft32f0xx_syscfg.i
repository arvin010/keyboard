...
# 19 "..\\FTLib\\Src\\ft32f0xx_syscfg.c"
...
void SYSCFG_DeInit(void)
{
  ...
  ((SYSCFG_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CFGR1 &= ((uint32_t)0x00000003);
   
  ((SYSCFG_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->EXTICR[0] = 0;
  ((SYSCFG_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->EXTICR[1] = 0;
  ((SYSCFG_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->EXTICR[2] = 0;
  ((SYSCFG_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->EXTICR[3] = 0;
   
  ((SYSCFG_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CFGR2 |= 0;
}
...
void SYSCFG_MemoryRemapConfig(uint32_t SYSCFG_MemoryRemap)
{
  ...
  tmpctrl = ((SYSCFG_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CFGR1;

   
  tmpctrl &= (uint32_t) (~((uint32_t)0x00000003));

   
  tmpctrl |= (uint32_t) SYSCFG_MemoryRemap;

   
  ((SYSCFG_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CFGR1 = tmpctrl;
}
...
void SYSCFG_DMAChannelRemapConfig(uint32_t SYSCFG_DMARemap, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((SYSCFG_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CFGR1 |= (uint32_t)SYSCFG_DMARemap;
  }
  else
  {
...
void SYSCFG_I2CFastModePlusConfig(uint32_t SYSCFG_I2CFastModePlus, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((SYSCFG_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CFGR1 |= (uint32_t)SYSCFG_I2CFastModePlus;
  }
  else
  {
...
void SYSCFG_IRDAEnvSelection(uint32_t SYSCFG_IRDAEnv)
{
  ...
  ((SYSCFG_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CFGR1 &= ~(((uint32_t)0x000000C0));
  ((SYSCFG_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CFGR1 |= (SYSCFG_IRDAEnv);
}
...
void SYSCFG_EXTILineConfig(uint8_t EXTI_PortSourceGPIOx, uint8_t EXTI_PinSourcex)
{
  ...
  ((SYSCFG_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->EXTICR[EXTI_PinSourcex >> 0x02] &= ~tmp;
  ((SYSCFG_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->EXTICR[EXTI_PinSourcex >> 0x02] |= (((uint32_t)EXTI_PortSourceGPIOx) << (0x04 * (EXTI_PinSourcex & (uint8_t)0x03)));
}
...
void SYSCFG_BreakConfig(uint32_t SYSCFG_Break)
{
  ...
  ((SYSCFG_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CFGR2 |= (uint32_t) SYSCFG_Break;
}
