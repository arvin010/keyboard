...
uint8_t Vendor_data_Buffer[64] = {0};
...
void ep2_send_data(uint8_t rpt_type, uint8_t* dat, uint8_t len)
{
	switch(rpt_type)
	{
		case 0x01:
			...
			{
				ep2_send_buf[0] = 0x01;
				memcpy(&ep2_send_buf[1], dat, 5);
				
				USB_EP_Tx(0x02, ep2_send_buf, len);
			}
		break;
