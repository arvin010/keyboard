...
void TIM_Config(void)
{
  ...
  GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)), &GPIO_InitStructure);
  
  GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)), ((uint8_t)0x08), ((uint8_t)0x02));
  ...
  TIM_TimeBaseInit(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00012C00)), &TIM_TimeBaseStructure);
  ...
  TIM_OC1Init(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00012C00)), &TIM_OCInitStructure);


   
  TIM_Cmd(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00012C00)), ENABLE);

   
  TIM_CtrlPWMOutputs(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00012C00)), ENABLE);
}
