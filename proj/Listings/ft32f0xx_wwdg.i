...
void WWDG_SetPrescaler(uint32_t WWDG_Prescaler)
{
  ...
  tmpreg = ((WWDG_TypeDef *) (((uint32_t)0x40000000) + 0x00002C00))->CFR & ((uint32_t)0xFFFFFE7F);
   
  tmpreg |= WWDG_Prescaler;
   
  ((WWDG_TypeDef *) (((uint32_t)0x40000000) + 0x00002C00))->CFR = tmpreg;
}
...
void WWDG_SetWindowValue(uint8_t WindowValue)
{
  ...
  tmpreg = ((WWDG_TypeDef *) (((uint32_t)0x40000000) + 0x00002C00))->CFR & ((uint32_t)0xFFFFFF80);
...
void WWDG_EnableIT(void)
{
  ((WWDG_TypeDef *) (((uint32_t)0x40000000) + 0x00002C00))->CFR |= ((uint16_t)0x0200);
}
...
void WWDG_SetCounter(uint8_t Counter)
{
  ...
  ((WWDG_TypeDef *) (((uint32_t)0x40000000) + 0x00002C00))->CR = Counter & ((uint8_t)0x7F);
}
...
void WWDG_Enable(uint8_t Counter)
{
  ...
  ((void)0);
  ((WWDG_TypeDef *) (((uint32_t)0x40000000) + 0x00002C00))->CR = ((uint8_t)0x80) | Counter;
}
...
FlagStatus WWDG_GetFlagStatus(void)
{
  ...
  if ((((WWDG_TypeDef *) (((uint32_t)0x40000000) + 0x00002C00))->SR) != (uint32_t)RESET)
  {
    bitstatus = SET;
  }
  else
...
void WWDG_ClearFlag(void)
{
  ((WWDG_TypeDef *) (((uint32_t)0x40000000) + 0x00002C00))->SR = (uint32_t)RESET;
}
