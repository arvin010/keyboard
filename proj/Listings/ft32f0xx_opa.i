...
void OPA_DeInit(void)
{
  ((OPA_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CR = ((uint32_t)0x00000000);     
}
...
void OPA_Init(OPA_InitTypeDef* OPA_InitStruct)
{
  ...
  tmpreg = ((OPA_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CR;

    
  tmpreg &= (uint32_t) ~(((uint32_t)0x0001FFFF));
  ...
  ((OPA_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CR = tmpreg;  
}
...
void OPA_StructInit(OPA_InitTypeDef* OPA_InitStruct)
{
  OPA_InitStruct->OPA_OP0PSel = ((uint32_t)0x00000000);
  OPA_InitStruct->OPA_OP0NSel = ((uint32_t)0x00002000);
  OPA_InitStruct->OPA_OP0FR = ((uint32_t)0x00000000);
  OPA_InitStruct->OPA_OP0FCAPE = ((uint32_t)0x00000000);
  OPA_InitStruct->OPA_OPTODIG = ((uint32_t)0x00000080);
  OPA_InitStruct->OPA_OPTOIO = ((uint32_t)0x00000040);
}
...
void OPA_Cmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((OPA_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CR |= (uint32_t) (1<<0);
  }
  else
  {
     
    ((OPA_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CR &= (uint32_t)(~((uint32_t)1<<0));
  }
}
...
uint32_t OPA_GetOutputLevel(uint32_t OPA_OutLevel)
{
  ...
  if ((((OPA_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CR & OPA_OutLevel) != 0)
  {
    compout = OPA_OutLevel;
  }
  else
  {
    compout = ((uint32_t)0x00000000);
  }
...
uint8_t OPA_Cali(void)
{
  ...
  uint32_t opatmp32;
    ...
    ((OPA_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CR |= (uint32_t) (1<<8);

   
    ((OPA_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CR &= (uint32_t) (~(3<<13));

   
    ((OPA_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CR |= (uint32_t) ((1<<15));

   
    ((OPA_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CR &= (uint32_t) (~(1<<9));

   
    ((OPA_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CR |= (uint32_t) ((1<<7));

   
    ((OPA_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CR &= (uint32_t) (~(7<<10));
  
   
  ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)) ->PUPDR &= ~(((uint32_t)0x00000003) << ((uint16_t)2 * 2));	

  
   
   ((OPA_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CR &= (uint32_t) (~(0x1F<<1));
  CalDA=0;
  opadelay=0X0FFF;
  while(opadelay--);
  outstate=((OPA_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CR;		
  while(1){
  	CalDA++;
	if(CalDA>=0x1F) break;
	opatmp32=((OPA_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CR&(~(0x1f<<1));
	((OPA_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CR=opatmp32|(CalDA<<1);
  	opadelay=0X0FFF;
	while(opadelay--);
	if((outstate^((OPA_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CR)&(1<<16)) break;
  }
  ...
  CalDB=CalDA;
   while(1){
  	...
  	CalDB--;
	opatmp32=((OPA_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CR&(~(0x1f<<1));
	((OPA_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CR=opatmp32|(CalDB<<1);
  	opadelay=0X0FFF;
	while(opadelay--);
	if((outstate^((OPA_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CR)&(1<<16)) break;
  }
