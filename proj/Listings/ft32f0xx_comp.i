...
void COMP_DeInit(void)
{
  ((COMP_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CSR = ((uint32_t)0x00000000);     
}
...
void COMP_Init(uint32_t COMP_Selection, COMP_InitTypeDef* COMP_InitStruct)
{
  ...
  tmpreg = ((COMP_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CSR;

    
  tmpreg &= (uint32_t) ~(((uint32_t)0x00003FFE)<<COMP_Selection);
  ...
  ((COMP_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CSR = tmpreg;  
}
...
void COMP_StructInit(COMP_InitTypeDef* COMP_InitStruct)
{
  COMP_InitStruct->COMP_VipSel = ((uint32_t)0x00000002);
  COMP_InitStruct->COMP_VinSel = ((uint32_t)0x00000010) | ((uint32_t)0x00080000);
...
void COMP_Cmd(uint32_t COMP_Selection, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((COMP_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CSR |= (uint32_t) (1<<COMP_Selection);
  }
  else
  {
     
    ((COMP_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CSR &= (uint32_t)(~((uint32_t)1<<COMP_Selection));
  }
}
...
uint32_t COMP_GetOutputLevel(uint32_t COMP_Selection)
{
  ...
  ((void)0);
   ...
   if ((((COMP_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CSR & (((uint32_t)0x00004000)<<COMP_Selection)) != 0)
  {
    compout = ((uint32_t)0x00004000);
  }
  else
  {
...
void COMP_WindowCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((COMP_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CSR |= (uint32_t) ((uint32_t)0x00800000);
  }
  else
  {
...
void COMP_LockConfig(uint32_t COMP_Selection)
{
  ...
  ((COMP_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CSR |= (uint32_t) (((uint32_t)0x00008000)<<COMP_Selection);
}
