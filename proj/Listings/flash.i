...
uint8_t read_bytes(uint32_t addr, uint8_t* recv, uint8_t num);


void erase_page(uint32_t addr);

FLASH_Status write_word(uint32_t addr, uint32_t data);
void write_byte(uint32_t addr, uint8_t data);
uint8_t write_bytes(uint32_t addr, const uint8_t* data, uint8_t num);
