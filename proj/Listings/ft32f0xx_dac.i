...
void DAC_Ref_Config(uint32_t	DAC_RefSel)
{
	...
	tmpreg = ((DAC_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CTRL;
	tmpreg &= ~((uint32_t)(0x00000006));
	tmpreg |= DAC_RefSel;
	
	((DAC_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CTRL |= tmpreg;
}
...
void DAC_Cmd(FunctionalState NewState)
{
	if(NewState != DISABLE)
	{
		((DAC_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CTRL |= ((uint32_t)(0x00000001));
	}
	else
	{
		((DAC_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CTRL &= ~((uint32_t)(0x00000001));		
...
{  
  ...
  ((DAC_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->DATA1 = (uint32_t)Data;
}
...
{  
  ...
  ((DAC_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->DATA2 = (uint32_t)Data;
}
...
uint8_t DAC_Read_Reg(uint8_t DAC_Register)
{
  ...
  tmp = (uint32_t)(((uint32_t)0x40000000) + 0x00010000);
  tmp += DAC_Register;

   
  return (uint8_t)(*(volatile uint32_t *) tmp);
}
