...
void RCC_DeInit(void)
{
  ...
  ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFGR &= (uint32_t)0x08FFB80C;
  ...
  ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFGR3 &= (uint32_t)0xFFF0FEAC;
...
ErrorStatus RCC_WaitForHSEStartUp(void)
{
  ...
  do
  {
    ...
    StartUpCounter++;  
  } while((StartUpCounter != ((uint16_t)0x5000)) && (HSEStatus == RESET));
...
void RCC_LSEDriveConfig(uint32_t RCC_LSEDrive)
{
  ...
  ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->BDCR &= ~(((uint32_t)0x00000038));
...
void RCC_PLLConfig(uint32_t RCC_PLLSource, uint32_t RCC_PLLMul)
{
  ...
  ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFGR &= ~(((uint32_t)0x003C0000) | ((uint32_t)0x00018000));
...
void RCC_HSI48Cmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CR2 |= ((uint32_t)0x00010000);
  }
  else
  {
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CR2 &= ~((uint32_t)0x00010000);
...
void RCC_MCOConfig(uint8_t RCC_MCOSource, uint32_t RCC_MCOPrescaler)
{
  ...
  tmpreg &= ~(((uint32_t)0x70000000) | ((uint32_t)0x0F000000) | ((uint32_t)0x80000000));
...
{ 
  ...
  ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFGR3 &= ~((uint32_t)0x00000080);
   
  ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFGR3 |= RCC_USBCLK;
}
...
void RCC_GetClocksFreq(RCC_ClocksTypeDef* RCC_Clocks)
{
  ...
  switch (tmp)
  {
    ...
    case 0x08:   
      ...
      if (pllsource == 0x00)
      {
        ...
        pllclk = (((uint32_t)8000000) >> 1) * pllmull;
      }
      else
      {
        prediv1factor = (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFGR2 & ((uint32_t)0x0000000F)) + 1;
         
        pllclk = (((uint32_t)8000000) / prediv1factor) * pllmull; 
      }
      RCC_Clocks->SYSCLK_Frequency = pllclk;      
      break;
    case 0x0C:   
      RCC_Clocks->SYSCLK_Frequency = ((uint32_t)48000000);
      break;
    default:  
      RCC_Clocks->SYSCLK_Frequency = ((uint32_t)8000000);
      break;
  ...
  if((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFGR3 & ((uint32_t)0x00000080)) != ((uint32_t)0x00000080))
  {
     
    RCC_Clocks->USBCLK_Frequency = ((uint32_t)48000000);
  }
  else
  {
