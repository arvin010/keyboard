...
void EXTI_DeInit(void)
{
  ((EXTI_TypeDef *) (((uint32_t)0x40000000) + 0x00010400))->IMR = 0x0F940000;
  ((EXTI_TypeDef *) (((uint32_t)0x40000000) + 0x00010400))->EMR = 0x00000000;
  ((EXTI_TypeDef *) (((uint32_t)0x40000000) + 0x00010400))->RTSR = 0x00000000;
  ((EXTI_TypeDef *) (((uint32_t)0x40000000) + 0x00010400))->FTSR = 0x00000000;
  ((EXTI_TypeDef *) (((uint32_t)0x40000000) + 0x00010400))->PR = 0x006BFFFF;
}
...
void EXTI_Init(EXTI_InitTypeDef* EXTI_InitStruct)
{
  ...
  tmp = (uint32_t)(((uint32_t)0x40000000) + 0x00010400);

  if (EXTI_InitStruct->EXTI_LineCmd != DISABLE)
  {
     
    ((EXTI_TypeDef *) (((uint32_t)0x40000000) + 0x00010400))->IMR &= ~EXTI_InitStruct->EXTI_Line;
    ((EXTI_TypeDef *) (((uint32_t)0x40000000) + 0x00010400))->EMR &= ~EXTI_InitStruct->EXTI_Line;
    ...
    *(volatile uint32_t *) tmp |= EXTI_InitStruct->EXTI_Line;
    ...
    ((EXTI_TypeDef *) (((uint32_t)0x40000000) + 0x00010400))->RTSR &= ~EXTI_InitStruct->EXTI_Line;
    ((EXTI_TypeDef *) (((uint32_t)0x40000000) + 0x00010400))->FTSR &= ~EXTI_InitStruct->EXTI_Line;
...
void EXTI_GenerateSWInterrupt(uint32_t EXTI_Line)
{
  ...
  ((EXTI_TypeDef *) (((uint32_t)0x40000000) + 0x00010400))->SWIER |= EXTI_Line;
}
...
FlagStatus EXTI_GetFlagStatus(uint32_t EXTI_Line)
{
  ...
  if ((((EXTI_TypeDef *) (((uint32_t)0x40000000) + 0x00010400))->PR & EXTI_Line) != (uint32_t)RESET)
  {
    bitstatus = SET;
  }
  else
...
void EXTI_ClearFlag(uint32_t EXTI_Line)
{
  ...
  ((EXTI_TypeDef *) (((uint32_t)0x40000000) + 0x00010400))->PR = EXTI_Line;
}
