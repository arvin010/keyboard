...
void IWDG_WriteAccessCmd(uint16_t IWDG_WriteAccess)
{
  ...
  ((void)0);
  ((IWDG_TypeDef *) (((uint32_t)0x40000000) + 0x00003000))->KR = IWDG_WriteAccess;
}
...
void IWDG_SetPrescaler(uint8_t IWDG_Prescaler)
{
  ...
  ((void)0);
  ((IWDG_TypeDef *) (((uint32_t)0x40000000) + 0x00003000))->PR = IWDG_Prescaler;
}
...
void IWDG_SetReload(uint16_t Reload)
{
  ...
  ((void)0);
  ((IWDG_TypeDef *) (((uint32_t)0x40000000) + 0x00003000))->RLR = Reload;
}
...
void IWDG_ReloadCounter(void)
{
  ((IWDG_TypeDef *) (((uint32_t)0x40000000) + 0x00003000))->KR = ((uint16_t)0xAAAA);
}
...
void IWDG_SetWindowValue(uint16_t WindowValue)
{
  ...
  ((void)0);
  ((IWDG_TypeDef *) (((uint32_t)0x40000000) + 0x00003000))->WINR = WindowValue;
}
...
void IWDG_Enable(void)
{
  ((IWDG_TypeDef *) (((uint32_t)0x40000000) + 0x00003000))->KR = ((uint16_t)0xCCCC);
}
...
FlagStatus IWDG_GetFlagStatus(uint16_t IWDG_FLAG)
{
  ...
  ((void)0);
  if ((((IWDG_TypeDef *) (((uint32_t)0x40000000) + 0x00003000))->SR & IWDG_FLAG) != (uint32_t)RESET)
  {
    bitstatus = SET;
  }
  else
