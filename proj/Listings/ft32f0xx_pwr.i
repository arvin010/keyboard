...
void PWR_BackupAccessCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x00007000))->CR |= ((uint16_t)0x0100);
  }
  else
  {
     
    ((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x00007000))->CR &= (uint32_t)~((uint32_t)((uint16_t)0x0100));
  } 
}
...
void PWR_PVDLevelConfig(uint32_t PWR_PVDLevel)
{
  ...
  tmpreg = ((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x00007000))->CR;
  
   
  tmpreg &= ((uint32_t)0xFFFFFD1F);
  
   
  tmpreg |= PWR_PVDLevel;
  
   
  ((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x00007000))->CR = tmpreg;
}
...
void PWR_PVDCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x00007000))->CR |= ((uint16_t)0x0010);
  }
  else
  {
     
    ((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x00007000))->CR &= (uint32_t)~((uint32_t)((uint16_t)0x0010));
  } 
}
...
void PWR_WakeUpPinCmd(uint32_t PWR_WakeUpPin, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x00007000))->CSR |= PWR_WakeUpPin;
  }
  else
  {
...
void PWR_EnterSleepMode(uint8_t PWR_SLEEPEntry)
{
  ...
  if(PWR_SLEEPEntry == ((uint8_t)0x01))
  {
...
void PWR_EnterSTOPMode(uint32_t PWR_Regulator, uint8_t PWR_STOPEntry)
{
  ...
  else if (PWR_STOPEntry == ((uint8_t)0x02))
  {
  ...
  else
  {
    ...
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR |= (1UL << 1);
  }
}
...
void PWR_EnterSTANDBYMode(void)
{
  ...
  ((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x00007000))->CR |= ((uint16_t)0x0002);
...
FlagStatus PWR_GetFlagStatus(uint32_t PWR_FLAG)
{
  ...
  if ((((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x00007000))->CSR & PWR_FLAG) != (uint32_t)RESET)
  {
    bitstatus = SET;
  }
  else
...
void PWR_ClearFlag(uint32_t PWR_FLAG)
{
  ...
  ((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x00007000))->CR |=  PWR_FLAG << 2;
}
